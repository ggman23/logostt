...
def main() -> int:
    ...
    analyseur.add_argument(
        ...
        choices=("carte", "clicktt", "angleterre", "belgique", "autriche", "fftt",
                 "opendata"),
    ...
    if arguments.source == "clicktt":
        ...
        nouveaux = autriche.liste_des_clubs(client, arguments.limite)
